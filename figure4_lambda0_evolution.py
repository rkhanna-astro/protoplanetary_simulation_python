...
results = {
    ...
    'eta2': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0.0, 'func': 'process'},
    'eta2nw': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0.1, 'func': 'process'},
    'pre_eta2': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0.2, 'func': 'process'},
    # 'pre_eta2nw': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0.1, 'func': 'process'}
}
...
lambda_str_1 = r'$\Lambda_0 = 0.0$'
lambda_str_2 = r'$\Lambda_0 = 0.1$'
lambda_str_3 = r'$\Lambda_0 = 0.2$'

plot_me_3times.plotme3times((plot_mat_1, lambda_str_1), (plot_mat_2, lambda_str_2), (plot_mat_3, lambda_str_3), None, 'figure_4')
