...
def plotme(plotmat, plotmat1=None, plotmat2=None, plotmat3=None):
    ...
    # Add text labels
    ax1.text(5, 1.5, r'$v_{\rm \phi}$', fontsize=15)
    ax1.text(5, 0.2, r'$c_{\rm s}$', fontsize=15)
    ax1.text(5, 0.02, r'$v_{\rm r}$', fontsize=15)
    
    # Add power law fits (simplified version)
