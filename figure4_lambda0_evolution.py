...
results = {
    ...
    'eta2': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0, 'func': 'process'},
...
plot_me_3times.plotme3times(plot_mat_1, plot_mat_2, plot_mat_3, None, 'figure_4')
