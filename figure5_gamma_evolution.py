...
results = {
    ...
    'eta2': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.0, 'lambda': 0.1, 'func': 'process'},
    'eta2nw': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.05, 'lambda': 0.1, 'func': 'process'},
    'pre_eta2': {'tps': [], 'Mdisk': [], 'Ewind': [], 'alpha': 0.5, 'etaprime': 0.01, 'gamma': 1.1, 'lambda': 0.1, 'func': 'process'},
...
gamma_str_1 = r'$\gamma = 1.0$'
gamma_str_2 = r'$\gamma = 1.05$'
gamma_str_3 = r'$\gamma = 1.1$'

plot_me_3times.plotme3times((plot_mat_1, gamma_str_1), (plot_mat_2, gamma_str_2), (plot_mat_3, gamma_str_3), None, 'figure_5')
