...
eta_str_1 = r'$\eta^{\prime}=10^{-1}$'
eta_str_2 = r'$\eta^{\prime}=10^{-2}$'
eta_str_3 = r'$\eta^{\prime}=10^{-3}$'
eta_str_4 = r'$\eta^{\prime}=10^{-4}$'

plot_me_3times.plotme3times((plot_mat_1, eta_str_1), (plot_mat_2, eta_str_2), (plot_mat_3, eta_str_3), (plot_mat_4, eta_str_4), 'figure_3')
